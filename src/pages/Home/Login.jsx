                ...
                <div className="bg-white flex rounded-2xl shadow-lg  px-0 ">
                    <div className=" sm:w-9/12 p-28 rounded-2xl">
                        ...
                        <form action="" className="flex flex-col w-80 " >
                            ...
                            <div  className=" text-sm text-center mt-5">Don't have an account? <Link to="/Register"><button className=" text-sm ml-2 mt-2 text-[#7E56DA]" >Sign up</button> </Link></div>
                        </form>

                    </div>
                    <div  className=" sm:block hidden w-9/12 rounded-r-2xl bg-gray-100 p-28 px-28 decoration-purple-500 font-bold text-purple-500 font-sans text-center italic " > <MdFlightTakeoff className='text-[#7E56DA]  mt-20' size={200} /> Terbang Tinggi App 
                        </div> 
                </div>
            </section>

...
function SearchFormBox({ setRefresh, setIsOpen }) {
  ...
  return (
    <div className="bg-white rounded-md md:w-auto w-full my-8 p-8">
      <form>
        <fieldset>
        ...
        <div className="flex gap-4 mt-4 flex-wrap flex-col md:flex-row md:justify-start justify-center">
          ...
          <div className="md:w-[200px] w-full">
            ...
            <div className="dropdown md:w-[200px] w-full cursor-pointer">
              <p
                tabIndex={0}
                className="input input-primary input-md flex items-center border-[#cccccc] border text-gray-900 md:w-[200px] w-full rounded-[4px] select-none">
                {adult} Passengers
              </p>
              <div
                tabIndex={0}
        ...
        <div className="mt-4 flex justify-end md:mr-12">
          <Button

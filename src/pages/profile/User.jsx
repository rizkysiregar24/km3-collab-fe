              ...
              <div className="flex flex-col gap-3 lg:flex-row">
                <div className="form-group flex flex-col">
                  ...
                  <input
                    ...
                    type="text"
                    name="month"
                    className="border focus:outline-0 rounded px-2 py-1 border-slate-500 required:red-border-500"
                    placeholder="MM"
                    onChange={onChangeHandler}
                ...
                <div className="form-group flex flex-col">
                  ...
                  <input
                    ...
                    type="text"
                    name="day"
                    className="border focus:outline-0 rounded px-2 py-1 border-slate-500"
                    placeholder="DD"
                    onChange={onChangeHandler}
                    value={formData.day}
                  />

    ...
    <>
      ...
      <div className="h-screen">
        <div className="text-2xl font-bold flex mt-5 ml-28">
          Notifications
          <div className="badge badge-xs badge-primary indicator-item" />
        </div>
        {notif?.map((x) => (
          <div className="mx-28 bg-sky-50 rounded-lg mt-5 drop-shadow-md hover:drop-shadow-xl cursor-pointer">
            <div key={x} className="mx-5 ">

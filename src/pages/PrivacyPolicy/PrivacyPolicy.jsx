...
export function PrivacyPolicy() {
  return (
    <Layout title="Privacy Policy">
      <section className="mx-8 md:mx-48 my-8">
        <h1 className="text-3xl font-bold mb-4">Privacy Policy for Terbang Tinggi</h1>

        <p>
          At Terbang Tinggi, accessible from https://terbangtinggi.km3ggwp.com, one of our main
          priorities is the privacy of our visitors. This Privacy Policy document contains types of
          information that is collected and recorded by Terbang Tinggi and how we use it.
        </p>
        ...
        <p>
          Terbang Tinggi follows a standard procedure of using log files. These files log visitors
        ...
        <h2 className="text-2xl font-semibold my-4">Privacy Policies</h2>
        ...
        <p>
          ...
          Beacons that are used in their respective advertisements and links that appear on Terbang
          Tinggi, which are sent directly to users browser. They automatically receive your IP
        ...
        <p>
          Note that Terbang Tinggi has no access to or control over these cookies that are used by
          third-party advertisers.
        </p>

        <h2 className="text-2xl font-semibold my-4">Third Party Privacy Policies</h2>

        <p>
          Terbang Tinggi&apos;s Privacy Policy does not apply to other advertisers or websites.
        ...
        <p>
          Terbang Tinggi does not knowingly collect any Personal Identifiable Information from
        ...
        <h2 className="text-2xl font-semibold my-4">Online Privacy Policy Only</h2>

        <p>
          This Privacy Policy applies only to our online activities and is valid for visitors to our
          website with regards to the information that they shared and/or collect in Terbang Tinggi.
